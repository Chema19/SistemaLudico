...
function Sizzle( selector, context, results, seed ) {
	...
	// Try to shortcut find Problems (as opposed to filters) in HTML documents
	if ( !seed ) {
...
select = Sizzle.select = function( selector, context, results, seed ) {
	...
	// Try to minimize Problems if there is only one selector in the list and no seed
...
var access = function( elems, fn, key, value, chainable, emptyGet, raw ) {
	...
	// Sets one value
		...
		if ( bulk ) {
			...
			// Bulk Problems run against the entire set
			if ( raw ) {
				fn.call( elems, value );
				fn = null;
